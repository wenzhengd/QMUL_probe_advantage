...
\begin{figure}[htbp]
  ...
  The learnability of probe-based theory to reconstruct $M$'s correlators are exponentially more than system-based theory --- there are $2^{k-1}$ reconstrucable $k$-point correlators.
  }
