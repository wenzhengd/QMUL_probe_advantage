...
= \mathrm{Tr}\!\left[
U_I^\dagger(T)\, A(T)\, U_I(T)\, \rho_0
\right],
\end{equation}
with \(\rho_0\) the initial system state prepared before the perturbation is applied.
...
\end{equation}
and $\expect{\bullet}\equiv = \Tr[\bullet \rho]$.
...
\WD{Not only we need to add refs on GNR / LR theory in conventional many-body physics, we should also illustrate if NEW tools -e.g., classical shadow- essentially described by respons theory. Absence of such might weaken our impact. }
